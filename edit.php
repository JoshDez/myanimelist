<html>
    ...
    <body>
        <center>
        <h1>ADD NEW ANIME</h1>
        <form method="post" action="action_edit.php" onsubmit="return validateForm()">
            ...
            <table>
                ...
                <tr>
                    <td><input type="text" name="name" class = "tb" value="<?php echo $data['name']?>"></td>
                </tr>
                <tr>
                    <td>Genre</td>
                </tr>
                <tr>
                    <td><input type="text" name="genre" class = "tb" value="<?php echo $data['genre']?>"></td>
                </tr>
                <tr>
                    <td>Description</td>
                </tr>
                <tr>
                    <td><textarea name="description" class = "large-tb"><?php echo $data['description']?></textarea></td>
                </tr>
                <tr>
                    <td>Picture</td>
                </tr>
                <tr>
                    <td><textarea name="picture" class = "large-tb"><?php echo $data['imageurl']?></textarea></td>
                </tr>
                <tr>
